<%@ Page Language="C#" MasterPageFile="~/Include/MasterPage/LoginTemplate.Master" AutoEventWireup="true" CodeBehind="frmLogin.aspx.cs" Inherits="GOF.Web.Application.WebApp.frmLogin" Title="GOF - Autenticación de Usuario" %>
